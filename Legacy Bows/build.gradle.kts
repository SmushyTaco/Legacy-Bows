...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        val file = upload(478857, remapJar)
        file.displayName = "[${project.extra["minecraft_version"] as String}] Legacy Bows"
...
modrinth {
    ...
    projectId.set("legacy-bows")
    uploadFile.set(tasks.remapJar)
    gameVersions.addAll(project.extra["minecraft_version"] as String)
    versionName.set("[${project.extra["minecraft_version"] as String}] Legacy Bows")
    dependencies {
